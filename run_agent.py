...
class AIAgent:
        ...
        def _run_review():
            ...
            try:
                with open(os.devnull, "w", encoding="utf-8") as _devnull, \
                    ...
                    # Background review forks run a normal Hermes tool loop.  Do
                    # not recursively hand them to codex app-server; they share
                    # the parent's OpenAI/Codex credentials but must downgrade
                    # to the legacy Responses path for memory/skill tools.
    ...
    def run_conversation(
        ...
        # turn to the codex app-server subprocess. The default Hermes tool loop
        # remains unchanged unless the runtime is explicitly selected.
