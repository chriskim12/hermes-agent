...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               ...
               subcommands=("list", "ls", "show", "create", "assign", "link", "unlink",
                            "claim", "comment", "complete", "closeout", "drift-audit", "audit-drift",
                            "block", "unblock", "archive", "tail", "dispatch", "context", "init", "gc")),
    CommandDef("autopilot", "Kanban-first autopilot status and bounded control surface",
               "Tools & Skills", args_hint="[status|dry-run|once|on|off|t_xxxxxxxx]",
               subcommands=("status", "dry-run", "once", "on", "off")),
    CommandDef("ouro-intake", "Create an Ouroboros-style Seed Contract admission card in Kanban",
               "Tools & Skills", args_hint="goal:<text> project:<bo|dc|ws|rs> [tenant:<name>]",
               aliases=("ouro_intake",)),
