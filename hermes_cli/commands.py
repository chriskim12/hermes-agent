...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("init", "boards", "create", "native-create", "swarm",
                            "list", "ls", "show", "assign", "reclaim", "reassign",
                            "diagnostics", "diag", "link", "unlink", "claim",
                            "comment", "complete", "closeout", "drift-audit",
                            "audit-drift", "edit", "block", "unblock", "promote",
                            "schedule", "archive", "tail", "dispatch", "stats",
                            "notify-subscribe", "notify-list", "notify-unsubscribe",
                            "log", "runs", "heartbeat", "assignees", "context",
                            "specify", "decompose", "gc")),
    CommandDef("autopilot", "Kanban-first autopilot status and bounded control surface",
               "Tools & Skills", args_hint="[status|dry-run|queue|on|pause|off|stop|focus]",
               subcommands=("status", "dry-run", "queue", "on", "pause", "off", "stop", "focus")),
