...
def test_gateway_dispatcher_disables_corrupt_board_without_traceback(
    ...
    # First tick connect (dispatch) + one combined ready/review probe.
    # The second dispatch tick skips the dispatch connect because the corrupt
    # board fingerprint is disabled, but the combined ready/review probe still
    # connects once per tick.
